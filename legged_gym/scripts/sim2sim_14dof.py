...
def get_obs(data,model):
    ...
    foot_positions = []
    foot_forces = []
    print("model.nbody len :",(model.nbody))
...
def run_mujoco(policy, cfg):
    ...
    print("num_actuated_joints:", num_actuated_joints)
...
if __name__ == '__main__':
    ...
    class Sim2simCfg(x114DOF_Cfg):
        ...
        class robot_config:
            kps = np.array([50, 50, 70, 70, 20, 20,10, 
                            50, 50, 70, 70, 20, 20,10], dtype=np.double)
            kds = np.array([5.0, 5.0, 7.0, 7.0, 2, 2,2, 
                            5.0, 5.0, 7.0, 7.0, 2, 2,2], dtype=np.double)
            tau_limit = 500. * np.ones(14, dtype=np.double)
            default_dof_pos = np.array([0.4, 0.05, -0.31, 0.49, -0.21, 0.0, 0.05, 
                                        -0.4, -0.05, 0.31, 0.49, -0.21,0.0, 0.05])
