...
class hi(LeggedRobot):
    ...
    def compute_ref_state(self):
        ...
        self.ref_dof_pos[:, 6] = 0  # l_shoulder_pitch_joint

        # right
        sin_pos_r[sin_pos_r < 0] = 0
        self.ref_dof_pos[:, 6] = -sin_pos_r * scale_1  # l_shoulder_pitch_joint
        self.ref_dof_pos[:, 13] = sin_pos_l * scale_1  # r_shoulder_pitch_joint
...
# ================================================ Rewards ================================================== #
    ...
    def _reward_default_joint_pos(self):
        ...
        right_yaw_roll = joint_diff[:, [7,8,12]]
