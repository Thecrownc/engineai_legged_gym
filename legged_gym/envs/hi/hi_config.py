...
class hiCfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/hi/urdf/hi_1_21_240815_rl.urdf'

        name = "hi_1_21_240815_rl"
        foot_name = "ankle_roll"  #脚底
        knee_name = "calf"    #膝盖

        terminate_after_contacts_on = ['base_link',"shoulder_pitch_link"]
        penalize_contacts_on = ["base_link","shoulder_pitch_link"]
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {'hip_yaw_joint': 50, 'hip_roll_joint': 50,'thigh_joint': 70,
                     'calf_joint': 70, 'ankle_pitch_joint': 20, 'ankle_roll_joint': 20,'shoulder_pitch_joint':20}
        damping = {'hip_yaw_joint': 5.0, 'hip_roll_joint': 5.0,'thigh_joint': 7.0,
                   'calf_joint': 7.0, 'ankle_pitch_joint': 2, 'ankle_roll_joint': 2,'shoulder_pitch_joint':2}
    ...
    class rewards:
        base_height_target = 0.33   #base_link 到 ankle 的距离 ，腿部完全伸直时大约为0.375m，步态时微蹲(0.32-0.35)
        min_dist = 0.13
        max_dist = 0.30
...
class hiCfgPPO(LeggedRobotCfgPPO):
    ...
    class algorithm(LeggedRobotCfgPPO.algorithm):
        ...
        act_permutation = [-7, -8, 9, 10, 11, -12, -13, -0.0001, -1, 2, 3, 4, -5, -6]
        frame_stack = 15
        sym_coef = 1.0
