...
class x114DOF_Cfg(LeggedRobotCfg):
    """
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/x1_14DOF/urdf/x1_14DOF.urdf'
...
class x114DOF_CfgPPO(LeggedRobotCfgPPO):
    seed = 5
